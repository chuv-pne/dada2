...
Analysis author: (ex: my name, may.name@xy.com)

Investigators: (ex: my name, may.name@xy.com)
...
packrat::restore()
# Make sure that the packrat library path is correct. If needed, edit the `.libPaths` command accordingly.
.libPaths(file.path("packrat", list.files("packrat", pattern = "lib"), "x86_64-pc-linux-gnu", "3.6.0"))
```
...
*Warning:* Samples with no reads or a very low number of reads passing the filter may interefer further analysis. We therefore recommend removing them before the next step.     
